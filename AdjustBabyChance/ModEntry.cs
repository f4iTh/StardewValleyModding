...
namespace AdjustBabyChance {
  public class ModEntry : Mod {
    ...
    public override void Entry(IModHelper helper) {
      ...
      Harmony harmony = new("com.f4iTh.AdjustBabyChance");
      harmony.Patch(helper.Reflection.GetMethod(typeof(Utility), "pickPersonalFarmEvent").MethodInfo, new HarmonyMethod(typeof(EventPatch), "Prefix"));
    }
