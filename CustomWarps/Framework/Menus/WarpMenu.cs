...
namespace CustomWarps.Framework.Menus {
    ...
    public class WarpMenu : IClickableMenu {
        ...
        private readonly List<Dictionary<ClickableTextureComponent, CustomWarp>> pagesOfCustomWarps = new List<Dictionary<ClickableTextureComponent, CustomWarp>>();
        private readonly List<Dictionary<ClickableTextureComponent, CustomWarp>> pagesOfRemoveButtons = new List<Dictionary<ClickableTextureComponent, CustomWarp>>();
        ...
        private void SetUpWarpPages() {
            ...
            foreach (KeyValuePair<string, CustomWarp> pair in ModEntry.WarpHelper.CustomWarps) {
                ...
                ClickableTextureComponent warp = new ClickableTextureComponent($"{pair.Value.WarpName}",
        ...
        private void SetUpRemoveWarpPages() {
            ...
            foreach (KeyValuePair<string, CustomWarp> pair in ModEntry.WarpHelper.CustomWarps) {
                ...
                ClickableTextureComponent warpRemove = new ClickableTextureComponent($"Remove {pair.Value.WarpName}",
                    new Rectangle(this.xPositionOnScreen + 48 + x1 * 64 + x1 * 16,
