...
namespace CustomWarps.Common {
  /// <summary>
  /// A helper class for handling custom warp data.
  /// </summary>
  public class WarpHelper {
    /// <inheritdoc cref="IDataHelper"/>
    private readonly IDataHelper _dataHelper;
    /// <summary>
    /// A dictionary containing all custom warps.
    /// </summary>
    public Dictionary<Guid, CustomWarp> CustomWarps;

    /// <summary>
    /// The constructor for the warp helper class.
    /// </summary>
    ...
    /// <summary>
    /// Tries to add a custom warp to the dictionary.
    /// </summary>
    ...
    /// <summary>
    /// Tries to remove a custom warp from the dictionary.
    /// </summary>
    /// <param name="id">The unique identifier of the warp.</param>
    /// <param name="isGlobal">Whether the warp can be accessed from any save file.</param>
    ...
    /// <summary>
    /// Updates the custom warp dictionary.
    /// </summary>
    private void Update() {
