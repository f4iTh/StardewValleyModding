...
namespace BreedLikeRabbits2 {
  public class ModEntry : Mod {
    ...
    private void AddKit(Building building) {
      FarmAnimal farmAnimal = new("Rabbit", this.Helper.Reflection.GetField<Multiplayer>(typeof(Game1), "multiplayer").GetValue().getNewID(), Game1.player.UniqueMultiplayerID) { Name = "Rabbit", home = building };
