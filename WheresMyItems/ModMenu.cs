...
namespace WheresMyItems {
  public class ModMenu : IClickableMenu {
    ...
    private readonly IDictionary<Vector2, List<Item>> _items = new Dictionary<Vector2, List<Item>>();
    ...
    public override void draw(SpriteBatch b) {
      ...
      foreach (KeyValuePair<Vector2, List<Item>> pair in this._items) {
        ...
        foreach (Item item in pair.Value) {
          ...
          //}
          b.Draw(Game1.objectSpriteSheet, pos, Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, item.ParentSheetIndex, 16, 16), Color.White, 0f, new Vector2(8f, 8f), 2f, SpriteEffects.None, 1f);
          count++;
        }
      }
    }
